...
export const API_BASE_URL = "http://localhost:6001/api"
...
export const API_ROUTE_ALL_MAPPINGS = API_BASE_URL + "/v1/raffle/all-mappings"
export const API_ROUTE_EDIT_MAPPINGS = API_BASE_URL + "/v1/raffle/set"
...
export const API_ROUTE_RAFFLE_NEXT = API_BASE_URL + "/v1/raffle/next"